...
**注** 通过启用`org.hibernate.SQL`记录器，你可以输出模式创建。如果你启用了[debug模式](https://docs.spring.io/spring-boot/docs/2.0.0.M5/reference/htmlsingle/#boot-features-logging-console-output)，这些会自动完成。
