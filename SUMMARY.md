...
* [IV. Spring Boot特性](IV. Spring Boot features/README.md)
   ...
   * [42. 测试](IV. Spring Boot features/42. Testing.md)
      ...
      * [42.3 测试Spring Boot应用](IV. Spring Boot features/42.3 Testing Spring Boot applications.md)
         ...
         * [42.3.9 自动配置的REST客户端](IV. Spring Boot features/42.3.9 Auto-configured REST clients.md)
         * [42.3.10 自动配置的Spring REST Docs测试](IV. Spring Boot features/42.3.10 Auto-configured Spring REST Docs tests.md)
         * [42.3.11 使用Spock测试Spring Boot应用](IV. Spring Boot features/42.3.11 Using Spock to test Spring Boot applications.md)
